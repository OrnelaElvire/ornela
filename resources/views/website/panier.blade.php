                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            @endphp
                                    ...
                                    <td class="product-name"><a href="#">{{ $prduct['name']}}</a></td>
                                    <td class="product-price-cart"><span class="amount">{{ $prduct['price']}}</span></td>
                                    <td class="product-quantity">
                                        <div class="cart-plus-minus">
                                            <input class="cart-plus-minus-box" type="text" name="qtybutton" value="{{$products['qty']}}">
                                        </div>
                                    </td>
