                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="product-action">
                                                ...
                                                <div class="pro-same-action pro-cart">
                                                    ...
                                                    <form metod="post" action="{{ route('panie.addtocart')}}">

                                                        @csrf
                                                        <imput type="hidden" name="id" value="{{ $product->id}}">
                                                        <imput type="hidden" name="name" value="{{ $product->name}}">
                                                        <imput type="hidden" name="price" value="{{ $product->price}}">
                                                        <imput type="hidden" name="qty" value="1">
                                                        <imput type="hidden" name="photo1" value="{{ $product->photo1}}">
